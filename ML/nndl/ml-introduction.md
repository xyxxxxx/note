...
![Screenshot from 2020-09-03 15-10-09.png](https://i.loli.net/2020/09/03/QoUBMEjRXuJzZ8A.png)
...
![Screenshot from 2020-09-03 16-14-47.png](https://i.loli.net/2020/09/03/sUabBP13eAh6oyV.png)
...
$$
![Screenshot from 2020-09-03 16-51-09.png](https://i.loli.net/2020/09/03/DQYsLq7M5TbRema.png)
...
![Screenshot from 2020-09-03 16-36-06.png](https://i.loli.net/2020/09/03/YJc2teTQhI8UbvH.png)
...
![Screenshot from 2020-09-03 18-00-05.png](https://i.loli.net/2020/09/03/WZLiyxq1zEue6K2.png)
...
![Screenshot from 2020-09-04 15-31-46.png](https://i.loli.net/2020/09/04/fdGCwQEms15XTcu.png)
...
![Screenshot from 2020-09-04 15-31-36.png](https://i.loli.net/2020/09/04/YLd74xBmu5A1RTt.png)
...
![Screenshot from 2020-09-04 10-29-46.png](https://i.loli.net/2020/09/04/QTfOXJ9toj6lNFR.png)
...
![Screenshot from 2020-09-04 10-50-59.png](https://i.loli.net/2020/09/04/CVQRfXBsWMGt8Em.png)
...
局部表示有两个优点：(1) 这种离散的表示方式具有很好的解释性, 有利于人工归纳和总结特征, 并通过特征组合进行高效的特征工程；(2) 通过多种特征组合得到的表示向量通常是稀疏的二值向量，当用于线性模型时计算效率非常高。但局部表示有两个不足之处：(1) one-hot 向量的维数很高且不能扩展，如果有一种新的颜色那么就需要增加一维来表示； (2) 不同颜色之间的相似度都为0，即我们无法知道“紫”和“紫罗兰”的相似度要高于“紫”和“绿”的相
似度。
...
![Screenshot from 2020-09-04 12-52-38.png](https://i.loli.net/2020/09/04/cvyG9dzPSxOpMtb.png)
...
![Screenshot from 2020-09-04 13-31-56.png](https://i.loli.net/2020/09/04/elzfAJ2FWYsiqod.png)
...
![Screenshot from 2020-09-04 13-53-30.png](https://i.loli.net/2020/09/04/aj4dY5ZuKnpDk9R.png)
